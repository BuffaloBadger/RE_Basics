...
Equations [-@eq-cum_age_from_impulse] and [-@eq-total_tracer_in_impulse] are written in terms of the total mass flow rate and inlet and outlet mass fractions. This is convenient because at steady-state, the total mass flow rate is constant. However, the cumulative age distribution function can also be generated by measuring the mass or molar concentration of the tracer. Equations [-@eq-cum_age_from_impulse] and [-@eq-total_tracer_in_impulse] can be converted to use mass or molar concentrations using the relationships from @sec-1_1_4_comp_reacting_systems.
...
#| echo: false
#| output: false
df <- read.csv("examples/reb_22_5_1/data.csv")
```

{{< include examples/reb_22_5_1/narrative.qmd >}}

The first few data are presented in @tbl-example_22_5_1_data, and the full data set is saved in the file, [data.csv](examples/reb_22_5_1/data.csv). Use those data to generate the cumulative age distribution function for the reactor.
...
![Response to the impulse stimulus.](examples/reb_22_5_1/response.png){#fig-example_22_5_1_response width="70%"}
...
![Cumulative age distribution function generated from the experimental response to the impulse stimulus](examples/reb_22_5_1/cum_age_dist.png){#fig-example_22_5_1_F_vs_lambda width="70%"}
...
#| echo: false
#| output: false
df <- read.csv("examples/reb_22_5_1/results.csv")
...
![Cumulative age distribution function based upon the first 10 response data calculated using the actual impulse mass and the impulse mass calculated using @eq-total_tracer_in_impulse.](examples/reb_22_5_1/cum_age_dist_comp.png){#fig-example_22_5_1_comp width="70%"}
...
![Schematic representaion of the ideal PFR.](examples/reb_22_5_3/pfr_non_adiabatic.png){#fig-example_22_5_3_schematic width="50%"}
