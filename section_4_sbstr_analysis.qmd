...
$$
n_{A,initial} = n_{A,sb,f} = n_A\big\vert_{t=t_{add}} \tag{13}
$$

$$
n_{B,initial} = n_{B,sb,f} = n_B\big\vert_{t=t_{add}} \tag{14}
$$

$$
n_{D,initial} = n_{D,sb,f} = n_D\big\vert_{t=t_{add}} \tag{15}
$$

$$
n_{U,initial} = n_{U,sb,f} = n_U\big\vert_{t=t_{add}} \tag{16}
$$

$$
T_{initial} = T_{sb,f} = T\big\vert_{t=t_{add}} \tag{17}
$$
...
$$
\underline{\dot{V}} = \left[\dot{V}_1,\cdots, \dot{V}_N\right]:\,\dot{V}1 = 30, \dot{V}_i \lt \dot{V}_{1+1} \text{ and } \dot{V}_N = 300 \tag{31}
$$

$$
\forall \dot{V}_i \begin{pmatrix}
\begin{matrix}
\dot{V}_i \\
\Downarrow \\
\text{SBSTR function} \\
\Downarrow \\
\underline{t}, \underline{n}_A, \underline{n}_B, \underline{n}_S, \underline{n}_W, \underline{T} ,\underline{T}_{ex,out}
\end{matrix}\\
\\
\begin{matrix}
...
$$
\dot{V}_{opt} = \dot{V}_i \,: t_{proc,i} = \min{\left(\underline{t}_{proc}\right)} \tag{33}
$$
