...
The analysis of SBSTRs is very similar to the analysis of BSTRs which is described in @sec-4_bstr_analysis. After identifying the assigment as one involving the analysis of an isolated ideal SBSTR, [Chapter -@sec-3_react_eng_tasks], the analysis can be completed in four general steps ([Chapter -@sec-3_formulating_calcs]): summarize the information provided, formulate the solution mathematically, implement the solution numerically, and present and discuss the results.
