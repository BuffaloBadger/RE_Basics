function example_25_3_1_discussion
    ...
    function [nA5, nB5, nZ5, nI5, fA1, fA2] = zoned_reactor(f_feedR2)
    ...
    function quantities_of_interest()
        ...
        % allocate storage for the conversions
        fA = nan(100,1);
        fA1 = nan(100,1);
        fA2 = nan(100,1);
        ...
        for i = 1:100
            ...
            [nA5, ~, ~, ~, f1, f2] = zoned_reactor(f_feedR2(i));
        ...
        % plot the results
        figure; 
        plot(100*f_feedR2,fA1,100*f_feedR2,fA2,'LineWidth',2)
        set(gca, 'FontSize', 14);
        xlabel('Percent of Feed to Less Dense Bed','FontSize', 14)
        ylabel('Percent Conversion','FontSize', 14)
        legend({h nh m'R1','R2'},'Location','northeast','FontSize',14)
        saveas(gcf,"example_25_3_1_discussion.png")
    end
