function reb_10_5_2
% Calculations for Reaction Engineering Basics Example 10.5.2
    % global constants
    ...
    function ddt = derivatives(t, dep)
        ...
        ddt = [dAdt; dBdt; dDdt; dUdt; dTdt];
    end

    % SBSTR function
    function [t, nA, nB, nD, nU, T] = SBSTR_variables(tAdd)
        % make tAdd available to the derivatives function
        g_tAdd = tAdd;
        ...
        [t1, dep1, flag] = solve_ivodes(ind_0, dep_0, stop_var...
