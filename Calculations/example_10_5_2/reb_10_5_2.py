...
def SBSTR_variables(tAdd):
    ...
    # solve the IVODEs
    t1, dep1, success, message = solve_ivodes(ind_0, dep_0, 
                stop_var, stop_val, derivatives, False)
    ...
    t2, dep2, success, message = solve_ivodes(ind_0, dep_0, 
                stop_var, stop_val, derivatives, False)
