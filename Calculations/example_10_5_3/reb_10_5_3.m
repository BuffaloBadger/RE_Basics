function reb_10_5_3
% Calculations for Reaction Engineering Basics Example 10.5.3
    % global constants
    k0_1 = 1.192E15; % /min
    E_1 = 97600.0; % J/mol
    dH_1 = -58615.0; % J/mol
    ...
    function ddt = derivatives(t, dep)
        ...
        ddt = [dAdt; dWdt; dZdt; dTdt; dTexdt];
    end

    % SBSTR function
    function [t, nA, nW, nZ, T, T_ex] = SBSTR_variables(Vdot_in)
        ...
        [t2, dep2, flag] = solve_ivodes(ind_0, dep_0, stop_var...
    ...
    function deliverables()
        ...
        [t, nA, ~, ~, T, Tex] = SBSTR_variables(Vdot_opt);
