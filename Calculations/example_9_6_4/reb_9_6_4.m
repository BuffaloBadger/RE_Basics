function reb_9_6_4
% Calculations for Example 9.6.4 of Reaction Engineering Basics
    % global constants
    k_0 = 2.59E9; % /min
    E = 16500; % cal/mol
    dH = -22200; % cal/mol
    ...
    function ddt = first_stage_derivatives(~, dep)
    ...
    function ddt = second_stage_derivatives(~, dep)
        % extract necessary dependent variables for this integration step
        nA = dep(1);
        T = dep(3);
        Tex_out = dep(4);
    ...
    function [t, nA, nZ, T, Tex] = first_stage_BSTR_variables()
    ...
    function [t, nA, nZ, T, Tex_out] = second_stage_BSTR_variables...
            (mDot_ex, t_0, nA_0, nZ_0, T_0, Tex_0)
    ...
    function deliverables()
        ...
        for i = 1:100
            ...
            [t, ~, nZ, ~, ~] = second_stage_BSTR_variables(mDot_ex,...
                t_1(end), nA_1(end), nZ_1(end), T_1(end), Tex_1(end));
        ...
        % solve the second stage design equations using the optimum 
        % coolant flow
        [t_2, nA_2, ~, T_2, ~] = second_stage_BSTR_variables(mDot_max...
            , t_1(end), nA_1(end), nZ_1(end), T_1(end), Tex_1(end));
        ...
        saveas(gcf,"matlab_net_rate_vs_coolant_flow.png")
        ...
        saveas(gcf,"matlab_conversion_profile.png")
