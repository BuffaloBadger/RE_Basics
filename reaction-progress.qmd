...
I think it is good practice to begin by assigning each quantity given in the problem statement to the appropriate variable.
...
This problem provides the starting composition and asks me to express one final value in terms of another. From past experience, I know that the way to do this is to express each of the final values in terms of the apparent extent of reaction, and then eliminate the apparent extent from the two equations.
