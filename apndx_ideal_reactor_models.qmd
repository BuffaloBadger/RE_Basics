...
The Accumulation Rate term is the same as a BSTR or SBSTR, but it is convient to express it in terms of the molar flow rate, $\dot n_i$, instead of the moles, $n_i$. This is accomplished in the same way as in the CSTR mole balance.
