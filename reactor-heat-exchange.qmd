...
In both @eq-ext_fluid_energy_bal_sens and @eq-ext_fluid_energy_bal_latent, the rate of heat input into the reacting fluid, $\dot Q$, and the rate of heat input to the shell/jacket, $\dot Q_e$ are related as shown in @eq-equal-heat-exchange.
