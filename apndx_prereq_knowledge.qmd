...
(Brief overviews of the numerical solution of sets of ODEs are presented in [Appendices -@sec-apndx_solve_ivodes], [-@sec-apndx_solve_cvodes], and [-@sec-apndx_solve_bvodes].)
...
* Solving coupled value ordinary differential equations.
    * A brief overview of the numerical solution of  sets of coupled value ODEs is presented in [Appendix -@sec-apndx_solve_cvodes].
