# Notation and Terminology {#sec-apxa}
...
**Square brackets containing a list of vectors** are used to indicate concatenation of the vectors. There can be any number of vectors in the list.

* $\left[ \underline{a}, \underline{b}, \underline{c} \right]$ denotes a single vector containing the elements of $\underline{a}$, followed by the elements of $\underline{b}$, followed by the elements of $\underline{c}$.
