...
Note that these data were generated using the experimental design from [Example -@sec-example_18_1]. and the initial conditions from @tbl-example_18_1. The first few data points are shown in @tbl-example_19_1_data. The full data set is available in the .csv file [reb_19_1_data.csv](`r paste0(path_to_data,'reb_19_1_data.csv')`)
