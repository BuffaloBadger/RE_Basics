# Notation and Sign Conventions {#sec-apndx_notation}
...
**Confidence Intervals** for estimated parameters are reported as follows: value, 95%CI [lower_limit, upper_limit]. In other words, $m$ = 10 g, 95% CI [9.3, 11.2] means that the estimated value of $m$ is 10 g with a 95% confidence interval between 9.3 and 11.2.
