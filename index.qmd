...
Once [[SC]{style="color:blue"}[o]{style="color:black"}[RE]{style="color:red"}](http://buffalobadger.github.io/SCoRE/index.qmd) and the *Reaction Engineering Basics* revisions are complete, I will do another proofreading, take this callout down, and add the capability for readers to report errors and make suggestions.
