...
Those and other planned revisions will proceed in parallel with the development of [[SC]{style="color:blue"}[o]{style="color:black"}[RE]{style="color:red"}](http://buffalobadger.github.io/SCoRE/index.qmd), a Self-Study Course on Reaction Engineering that will be based on *Reaction Engineering Basics.* Increased interpretation and qualitative understanding of results will be a point of emphasis in those revisions, and in [[SC]{style="color:blue"}[o]{style="color:black"}[RE]{style="color:red"}](http://buffalobadger.github.io/SCoRE/index.qmd) itself.

Once [[SC]{style="color:blue"}[o]{style="color:black"}[RE]{style="color:red"}](http://buffalobadger.github.io/SCoRE/index.qmd) and the *Reaction Engineering Basics* revisions are complete, I will do another proofreading, take this callout down, and add the capability for readers to report errors, make suggestions, and comment.
