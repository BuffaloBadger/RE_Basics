...
$$
 ...
 If only one mole balance is being used in the analysis, the concentrations or partial pressures of reagents other than $i$ can be related to the molar flow rate of $i$ using the apparent extent of reaction as described in @sec-1_reaction_progress and illustrated in [Example -@sec-example_19_2].
