...
* be able to
    * identify a set of mathematically independent reactions/equations (-@sec-ch2_ex2, -@sec-ch2_ex4)
    * identify limiting reactants (-@sec-ch2_ex1)
    * write and use equations inter-relating initial composition, current composition, stoichiometry, and reaction progress (-@sec-ch2_ex2, -@sec-ch2_ex3, -@sec-ch2_ex4)
    * calculate heat of reaction as a function of temperature (-@sec-ch2_ex4)
