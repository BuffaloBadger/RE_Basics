...
After the mathematical form of a rate expression has been proposed, it must be validated using experimental kinetics data. That requires mathematical models for the reactors used in the experiments. So the third section of *Reaction Engineering Basics* examined the equations that are used to model four types of ideal reactors.
