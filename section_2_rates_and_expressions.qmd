...
#| echo: false
#| output: false
results <- read.csv("examples/reb_4_5_4/reb_4_5_4_data.csv")
...
#| echo: false
#| output: false
df <- read.csv("examples/reb_4_5_4/results.csv") %>%
    select(-item)
...
![Arrhenius plot comparing the model (line) to the experimental data (points).](examples/reb_4_5_4/Arrhenius_plot.png){#fig-example_4_5_4_fig width="80%"}
