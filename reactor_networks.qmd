...
The PFR model function will use an IVODE solver to solve the design equations, so in addition to the initial values and stopping criterion, I'll need to write a derivatives function.
