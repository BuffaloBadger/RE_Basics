...
The general form of the steady-state CSTR mole balance is given in @eq-cstr_ss_mole_bal, and in this system there is only one reaction occurring. I'll use $V_{Rx}$ to represent the volume of the reactor where $x$ can be either 1 or 2.
