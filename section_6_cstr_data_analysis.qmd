...
The calculations were performed as described above except that the base-10 logs of $k_{0,f}$ and $k_{0,r}$ were estimated instead of estimating $k_{0,f}$ and $k_{0,r}$ directly (see @sec-example_18_6_2). The fitting results are shown in @tbl-example_20_5_3_parameters. The parity plot is shown in @fig-example_20_5_3_parity and the residuals plots are shown in @fig-example_20_5_2_residuals_plots.
