...
The results from the parameter estimation were then used to create the parity plot shown in @fig-example_11_3_parity and residuals plots shown in @fig-example_11_3_residuals_plots as described in @sec-6_kin_data_gen.
