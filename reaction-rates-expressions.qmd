...
$$
\begin{align}
r_j &= k_{0,j}\exp{\left(\frac{-E_{j}}{RT}\right)} \left(\prod_{i_r} C_{i_r}^{-\nu_{i_r,j}}\right) \\
&- \frac{k_{0,j}\exp{\left(\frac{-E_{j}}{RT}\right)}}{K_{j,eq_c}} \left(\prod_{i_p} C_{i_p}^{\nu_{i_p,j}}\right)
\end{align}
...
$$
\begin{align}
r_j &= k_{0,j}\exp{\left(\frac{-E_{j}}{RT}\right)} \left(\prod_{i_r} P_{i_r}^{-\nu_{i_r,j}}\right) \\
&- \frac{k_{0,j}\exp{\left(\frac{-E_{j}}{RT}\right)}}{K_{j,eq_c}} \left(\prod_{i_p} P_{i_p}^{\nu_{i_p,j}}\right)
\end{align}
...
| $j$ | Subscript denoting a specific reaction occurring within the system. |
