...
$$
Y_{D/i,inst} = - \frac{\sum _j r_{D,j}}{\sum _j r_{i,j}}
$$ {#eq-def_inst_yield}
...
$$
S_{D/U,inst} = - \frac{-\sum _j r_{D,j}}{\sum _j r_{U,j}}
$$ {#eq-def_inst_select}
...
$$
\begin{align}
r_j &= k_{0,j}\exp{\left(\frac{-E_{j}}{RT}\right)} \left(\prod_{i=1}^{N_{\text{Reactants}}} C_i^{-\nu_{i,j}}\right) \\
&- \frac{k_{0,j}\exp{\left(\frac{-E_{j}}{RT}\right)}}{K_{j,eq_c}} \left(\prod_{i=1}^{N_{\text{Products}}} C_i^{\nu_{i,j}}\right)
\end{align}
...
$$
\begin{align}
r_j &= k_{0,j}\exp{\left(\frac{-E_{j}}{RT}\right)} \left(\prod_{i=1}^{N_{\text{Reactants}}} P_i^{-\nu_{i,j}}\right) \\
&- \frac{k_{0,j}\exp{\left(\frac{-E_{j}}{RT}\right)}}{K_{j,eq_c}} \left(\prod_{i=1}^{N_{\text{Products}}} P_i^{\nu_{i,j}}\right)
\end{align}
...
| $i$ | Index representing a reagent. |
| $j$ | Index representing a reaction. |
...
| $N_{\text{Products}}$ | Number of unique products produced in a specific elementary reaction. |
| $N_{\text{Reactants}}$ | Number of unique reactants that participate in a specific elementary reaction. |
