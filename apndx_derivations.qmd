...
Noting that then $\frac{d^2\dot{n}_i}{dz^2} = \frac{d\omega_i}{dz}$ and $\frac{d^2T}{dz^2} = \frac{d\omega_T}{dz}$, substitution into the second-order design equations converts them to first-order ODEs.
