...
## Describing Multiple-Reaction Systems {#sec-1_3_b_mult_reactions}
...
In order to use @eq-moles_apparent_extent or @eq-molar_flow_apparent_extent it is necessary to determine the number of mathematically independent reactions and then to find at least one such subset. @sec-apndx_pre_knowledge presents a very brief and succinct description of how to do this, and [Example -@sec-example_3_3] illustrates doing so.
...
## Mole Tables {#sec-1_3_c_mole_tables}
...
#| output: false
path_to_data <- './Data/'
path_to_results <- '../RE_Basics_Examples/reb_3_1/Results/'
...
#| output: false
path_to_data <- './Data/'
path_to_results <- '../RE_Basics_Examples/reb_3_2/Results/'
path_to_figures <- './Graphics/'
```
...
#| output: false
path_to_data <- './Data/'
path_to_results <- '../RE_Basics_Examples/reb_3_4/Results/'
path_to_figures <- './Graphics/'
```
...
## Symbols Used in @sec-1_reaction_progress {#sec-1_3_e_symbls}
