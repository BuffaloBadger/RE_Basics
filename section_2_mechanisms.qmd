...
It will be seen in later chapters of *Reaction Engineering Basics*, that a reaction engineer will commonly use the rate expression by substituting it into mole and energy balances for a reactor (see [Appendix -@sec-apndx_derivations]). When writing those mole and energy balances, the reaction engineer will not know the reaction mechanism; the reaction engineer will only know that reaction (1) takes place and that equation (10) is the rate expression for reaction (1).
