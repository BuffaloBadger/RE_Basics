...
$$
\begin{split}
\frac{V}{\dot{V}}\sum_i \left( \dot{n}_{i,1} \hat{C}_{p,i}  \right) &\frac{dT}{dt} - V \frac{dP}{dt} - P\frac{dV}{dt} = \dot Q - \dot W \\&- \sum_i\dot{n}_{i,0} \int_{T_{in}}^T \hat{C}_{p,i}dT - V\sum_j r_j \Delta H_j
\end{split}
...
$$
\frac{V}{\dot{V}}\sum_i \left( \dot{n}_{i,1} \hat{C}_{p,i}  \right) \frac{dT}{dt}\ \Leftarrow\ \rho V \tilde{C}_p \frac{dT}{dt}\ \Leftarrow\ V \breve{C}_p \frac{dT}{dt}
...
$$
P_i = \frac{ \dot{n}_i}{\displaystyle \sum_i \dot{n}_i}P
...
$$
C_i = \frac{\dot{n}_i}{\displaystyle \sum_i \dot{n}_i}\frac{P}{RT}
...
$$
\frac{dn_A}{dt} = \dot n_{A,in} - r_1V \tag{2}
$$
...
$$
\breve{C}_pV \frac{dT}{dt} - P\frac{dV}{dt} = \dot{Q} - \dot{V}_{in} \breve{C}_p \left( T - T_{in} \right)  - r_1  \Delta H_1 \tag{6}
$$
...
$$
\begin{align}
\breve{C}_pV & \frac{dT}{dt} - V\frac{dP}{dt} - P\frac{dV}{dt} = \dot{Q} - \dot{W} \\ &- \dot{V}_{0} \int_{T_{in}}^T \breve{C}_pdT  - V\sum_j r_j \Delta H_j
\end{align}
$$
...
$$
\begin{align}
\breve{C}_pV & \frac{dT}{dt} - V\cancelto{0}{\frac{dP}{dt}} - P\frac{dV}{dt} = \dot{Q} - \cancelto{0}{\dot{W}} \\ &- \dot{V}_{0} \breve{C}_p \left( T - T_{in} \right)  - r_1 V \Delta H_1
\end{align}
$$
...
$$
0 = \dot{Q} - \rho \dot{V}_{0} \tilde{C}_p  \left( T - T_{in} \right) - r_1 V \Delta H_1 \tag{5}
$$
...
$$
0 = \dot{Q} - \rho \dot{V}_{0} \int_{T_{in}}^T \hat{C}_{p,i}dT - r_1 V \Delta H_1
$$
