# Reaction Engineering, Ethics, and Safety {#sec-ch1}

Design and operation of processes that involve chemical reactions is one of the things that sets chemical engineering apart from other branches of engineering. This book provides an introduction to doing those things. This first chapter introduces the field of reaction engineering and presents a brief overview of two important aspects of reaction engineering that are often overlooked in textbooks and courses, namely ethics and safety. Though they may not fully make sense before reading the chapter, it may prove helpful to keep the Learning Objectives in [Section -@sec-ch1_learning_objectives] in mind while reading it.

## Reaction Engineering {#sec-ch1_rxn_engrng}
...
*Reaction Engineering Basics, The Book* (*REB, The Book*, for short) offers an introduction to reaction engineering. While it is limited in scope, it illustrates many of the kinds of problems that reaction engineers encounter. Chemical kinetics is a sub-discipline of chemistry that focuses upon the rates of chemical reactions. As chemical kinetics are essential for modeling reactors, *REB, The Book* also introduces essential aspects of chemical kinetics, in particular, the generation and analysis of data for the purpose of generating rate expressions for chemical reactions.

## Ethics {#sec-ch1_ethics}

Reaction engineers are entrusted with the design and operation of processes that can impact the health, safety and long term well-being of the general public, both directly and through intermediate environmental impacts. To earn and maintain that trust, reaction engineers must adhere to high ethical standards. Most engineering professional societies and many engineering schools have set forth codes of ethics. Professionals who practice reaction engineering are often members of the American Institute of Chemical Engineers (AIChE). The AIChE Code of Ethics [@american_institute_of_chemical_engineers_code_2012] is as follows.
...
This book is not about ethics, or even reaction engineering ethics. Nonetheless, they have been included here because every engineer should be aware of codes of ethics that have been developed for their field. Before you are confronted with an issue of ethics, it is useful to know what you *should* do, and to have thought about and committed to responding in an ethical manner. Establishing personal principles of ethical behavior now, and sticking with them in small matters, will be beneficial should larger ethical issues arise in the future.

## Safety {#sec-ch1_safety}
...
The fourth example involved a leaking valve that the operators believed to be closed. Ultimately this resulted in an explosion that threw a 35 foot section of a tower completely off the chemical plant site. Another chunk of the tower hit a storage tank setting it ablaze. Shrapnel landed close to nearby tanks, one containing crude oil and the other, anhydrous ammonia. Had any shrapnel ruptured those tanks, the effects would have been even more dire.

These accidents have been described here to drive home the point that the highest ethical standards must be used and safety must be the top priority when dealing with reactive processes. None of these accidents were desired nor expected. Some were caused by human error and others by a combination of equipment failure and not anticipating and planning for potential disruption of process conditions.
...
## Learning Objectives {#sec-ch1_learning_objectives}

Upon completion of this chapter, readers should

* know a definition for reaction engineering
* understand
    * the AIChE Code of Ethics
    * that process safety is paramount in the practice of reaction engineering