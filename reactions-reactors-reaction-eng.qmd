...
$$
x_i = \frac{n_i}{\sum _i\left(n_i\right)}
$${#eq-mole_frac_closed}

$$
\omega _i = \frac{m_i}{\sum _i \left(m_i\right)}
$${#eq-mass_frac_closed}
...
$$
x_i = \frac{\dot n_i}{\sum _i\left(\dot n_i\right)}
$${#eq-mole_frac_open}

$$
\omega _i = \frac{\dot m_i}{\sum _i \left(\dot m_i\right)}
$${#eq-mass_frac_open}
...
$$
\frac{n_{i,0}}{\left| \nu_i \right|}\Bigg\rvert_{\substack{ i\text{ = limiting} \\ \text{reactant}}} < \frac{n_{k,0}}{\left| \nu_k \right|}\Bigg\rvert_{\substack{ \text{all } k \, \neq  \text{ limiting} \\ \text{reactant}}}
$${#eq-lim_react_closed}
...
| Symbol | Meaning |
|:-------|:--------|
| $i$, $k$ | Index denoting a specific reagent. |
| $j$ | Index denoting a specific reaction. |
