...
## CSTR Mole and Energy Balances{#sec-apxc_CSTR_balances}

Three types of stirred tank reactors are considered in *Reaction Engineering Basics.* Continuous stirred tank reactors (CSTRs) are distinctive in that fluid flows into **and** out of CSTRs. The CSTR model makes the following assumptions.
...
## BSTR Mole and Energy Balances{#sec-apxc_BSTR_balances}

In contrast to CSTRs, there is no reacting fluid flow into or from a batch stirred tank reactor (BSTR). The BSTR model makes the following assumptions.
...
## PFR Mole and Energy Balances{#sec-apxc_PFR_balances}
...
The axial dispersion reactor design equations are boundary value ordinary equations (BVODEs) and must be solved using an appropriate solver (see [add ref to math appendix]).
